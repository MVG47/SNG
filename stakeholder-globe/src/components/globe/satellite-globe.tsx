...
export default function SatelliteGlobe({ stakeholders }: SatelliteGlobeProps) {
  ...
  // Initialize three-globe instance with satellite imagery
  useEffect(() => {
    if (!globeRef.current) return;

    const globe = new ThreeGlobe()
      // Globe appearance with satellite imagery
